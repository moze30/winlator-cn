            ...
            for (ContentProfile.ContentType type : ContentProfile.ContentType.values()) {
                ...
                switch (type) {
                    case CONTENT_TYPE_TURNIP:
                        paths = TURNIP_TRUST_FILES;
                        break;
                    case CONTENT_TYPE_VIRGL:
                        paths = VIRGL_TRUST_FILES;
                        break;
                    case CONTENT_TYPE_DXVK:
                        paths = DXVK_TRUST_FILES;
                        break;
                    case CONTENT_TYPE_VKD3D:
                        paths = VKD3D_TRUST_FILES;
                        break;
                    case CONTENT_TYPE_BOX64:
                        paths = BOX64_TRUST_FILES;
                        break;
                    case CONTENT_TYPE_FEX:
                        paths = FEX_TRUST_FILES;
                        break;
                    default:
                        paths = new String[0];
                        break;
